...
import { t as Route$3 } from "./projects._slug-D92GVkXB.js";
import { useEffect } from "react";
import { HeadContent, Link, Outlet, Scripts, createFileRoute, createRootRouteWithContext, createRouter, lazyRouteComponent, useRouter } from "@tanstack/react-router";
import { jsx, jsxs } from "react/jsx-runtime";
import { QueryClient, QueryClientProvider } from "@tanstack/react-query";
//#region src/styles.css?url
var styles_default = "/assets/styles-BRUlkstO.css";
//#endregion
...
var Route$2 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Selected works by Sonya Harris. A contemporary visual diary of painting, sculpture, drawing and photography."
			},
			{
				property: "og:title",
				content: "Sonya Harris — Visual Diary"
			},
			{
...
var $$splitComponentImporter = () => import("./routes-2XgJS-qZ.js");
...
var rootRouteChildren = {
	...
	SitemapDotxmlRoute,
	ProjectsSlugRoute: Route$3.update({
		id: "/projects/$slug",
		path: "/projects/$slug",
		getParentRoute: () => Route$2
	})
